...
-- The materialized views only see post-creation inserts. Backfill any existing
-- `github_events` rows separately after this migration is applied, using the
-- bounded recipe documented in docs/data/repo-drilldown-aggregates-backfill.md.
